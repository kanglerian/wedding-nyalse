            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4">
                        <Link href={route('category.index')} className="overflow-hidden border-2 text-white border-sky-400 bg-sky-500 hover:bg-sky-600 sm:rounded-2xl transition ease-in-out">
